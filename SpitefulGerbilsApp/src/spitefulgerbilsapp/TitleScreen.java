...
{        
     public static void firstmenu() throws IOException //Method for main menu
    {
        ...
        System.out.println("Enter 1 to sign up for user account, 2 to log in "); //Asks for response from user to make account or login
    ...
    public static void signUp() throws IOException  //Account creation method
    {
        ...
        writer.write(name+","+email+","+password+"\n");     //Writing name email and password to file with , between and new line for each section
    ...
    public static void signIn() throws IOException //Sign In method
    {
        ...
        while ((line = bufferedReader.readLine()) != null) //Sets line to equal the readline
        {
            ...
            //System.out.println(email_login);    //Testing the ability to read the line (keep for testing purposes) 
            //System.out.println(line_split[1]);
            //System.out.println(password_login);
            //System.out.println(line_split[2]);
            if(line_split[1].equals(email_login) && line_split[2].equals(password_login)) //Scans lines by section between , in order to look for matching email and passwords
            {
