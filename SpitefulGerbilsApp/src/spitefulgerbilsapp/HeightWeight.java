...
public class HeightWeight extends DiceRoller {
    ...
    public void scoreOne() {
        ...
        System.out.print(
                "What ability would you like to assign your score to? Strength, Dexterity, Constitution, Intelligence, Wisdom, or Charisma?");
        score1 = score.nextLine();
        if ("strength".equalsIgnoreCase(score1) || "dexterity".equalsIgnoreCase(score1)
                || "constitution".equalsIgnoreCase(score1) || "intelligence".equalsIgnoreCase(score1)
                || "wisdom".equalsIgnoreCase(score1) || "charisma".equalsIgnoreCase(score1)) {
    ...
    public void scoreTwo() {
        ...
        System.out.println(
                "What ability score would you like to assign your score to? Strength, Dexterity, Constitution, Intelligence, Wisdom, or Charisma?");
        score2 = scoreTwo.nextLine();
        if ("strength".equalsIgnoreCase(score2) || "dexterity".equalsIgnoreCase(score2)
                || "constitution".equalsIgnoreCase(score2) || "intelligence".equalsIgnoreCase(score2)
                || "wisdom".equalsIgnoreCase(score2) || "charisma".equalsIgnoreCase(score2)) {
    ...
    public void scoreThree() {
        ...
        if ("strength".equalsIgnoreCase(score3) || "dexterity".equalsIgnoreCase(score3)
                || "constitution".equalsIgnoreCase(score3) || "intelligence".equalsIgnoreCase(score3)
                || "wisdom".equalsIgnoreCase(score3) || "charisma".equalsIgnoreCase(score3)) {
    ...
    public void scoreFour() {
        ...
        if ("strength".equalsIgnoreCase(score4) || "dexterity".equalsIgnoreCase(score4)
                || "constitution".equalsIgnoreCase(score4) || "intelligence".equalsIgnoreCase(score4)
                || "wisdom".equalsIgnoreCase(score4) || "charisma".equalsIgnoreCase(score4)) {
    ...
    public void scoreFive() {
        ...
        if ("strength".equalsIgnoreCase(score5) || "dexterity".equalsIgnoreCase(score5)
                || "constitution".equalsIgnoreCase(score5) || "intelligence".equalsIgnoreCase(score5)
                || "wisdom".equalsIgnoreCase(score5) || "charisma".equalsIgnoreCase(score5)) {
    ...
    public void scoreSix() {
        ...
        if ("strength".equalsIgnoreCase(score6) || "dexterity".equalsIgnoreCase(score6)
                || "constitution".equalsIgnoreCase(score6) || "intelligence".equalsIgnoreCase(score6)
                || "wisdom".equalsIgnoreCase(score6) || "charisma".equalsIgnoreCase(score6)) {
    ...
    public void genGender() {
        ...
        System.out.println("Are you Male or Female?"); // Asking for gender and then setting the variable to a specific
                                                       // String based on input
        mf = gender.nextLine();
        if ("male".equalsIgnoreCase(mf)) {
            mf = "Male";
        } else if ("female".equalsIgnoreCase(mf)) {
    ...
    public void genAlignment() {
        ...
        System.out.println(
                "What is your alignment? Lawful Good, Lawful Evil, Neutral Good, Neutral Evil, Chaotic Good, or Chaotic Evil?");
        alnmt = alignment.nextLine();

        if ("lawful good".equalsIgnoreCase(alnmt) || "chaotic good".equalsIgnoreCase(alnmt)
                || "neutral good".equalsIgnoreCase(alnmt) || "lawful evil".equalsIgnoreCase(alnmt)
                || "chaotic evil".equalsIgnoreCase(alnmt) || "neutral evil".equalsIgnoreCase(alnmt)) {
